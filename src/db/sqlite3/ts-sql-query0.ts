...
import { Values } from 'ts-sql-query/Values'
...
class DBConnection extends SqliteConnection<'DBConnection'> {
  ...
  appendToAllCompaniesName(additional: string) {
    // Fake implementation for testing purposes
    return this.updateAllowingNoWhere(tCompany)
      .set({
        name: tCompany.name.concat(additional)
      })
      .executeUpdate()
  }
}

// I think this is like Entity in typeorm
...
const db = new Database('ts_sql_query0_sqlite3_memory')
...
async function main() {
  ...
  try {
    ...
    let i = await connection.insertInto(tCompany).values({ name: 'ACME' }).returningLastInsertedId().executeInsert()
    assertEquals(i, 1)

    const companyIdOne = await connection
      .selectFrom(tCompany)
      .where(tCompany.id.in([1]))
      .selectOneColumn(tCompany.id)
      .executeSelectMany()
    assertEquals(companyIdOne, [1])

    const companyIdEmpty = await connection
      .selectFrom(tCompany)
      .where(tCompany.id.in([]))
      .selectOneColumn(tCompany.id)
      .executeSelectMany()
    assertEquals(companyIdEmpty, [])

    i = await connection.insertInto(tCompany).values({ name: 'FOO' }).executeInsert()
    assertEquals(i, 1)
    ...
    i = await connection
      .insertInto(tCompany)
      .from(
        connection.selectFrom(tCompany).select({
    ...
    names = await connection.selectFrom(tCompany).selectOneColumn(tCompany.name).orderBy('result').executeSelectMany()
    ...
    i = await connection.deleteFrom(tCompany).where(tCompany.id.equals(2)).executeDelete()
    assertEquals(i, 1)
    ...
    const customerCountPerCompanyWith = connection
      .selectFrom(tCompany)
      .innerJoin(tCustomer)
      .on(tCustomer.companyId.equals(tCompany.id))
      .select({
    ...
    const customerCountPerAcmeCompanies = await connection
      .selectFrom(customerCountPerCompanyWith)
    ...
    const aggregatedCustomersOfAcme = connection
    ...
    const acmeCompanyWithCustomers = await connection
      .selectFrom(tCompany)
      .where(tCompany.id.equals(1))
      .select({
        id: tCompany.id,
    ...
    const acmeCompanyWithCustomers2 = await connection
      .selectFrom(tCompany)
      .leftJoin(tCustomerLeftJoin)
      .on(tCustomerLeftJoin.companyId.equals(tCompany.id))
      .where(tCompany.id.equals(1))
      .select({
        id: tCompany.id,
        name: tCompany.name,
    ...
    const aggregatedCustomersOfAcme3 = connection
      .subSelectUsing(tCompany)
      .from(tCustomer)
      .where(tCustomer.companyId.equals(tCompany.id))
      .selectOneColumn(
        connection.aggregateAsArrayOfOneColumn(tCustomer.firstName.concat(' ').concat(tCustomer.lastName))
      )
      .forUseAsInlineQueryValue()

    const acmeCompanyWithCustomers3 = await connection
      .selectFrom(tCompany)
      .where(tCompany.id.equals(1))
      .select({
        id: tCompany.id,
    ...
    assertEquals(acmeCompanyWithCustomers3, {
      id: 1,
      name: 'ACME',
      customers: ['Jane Doe', 'John Smith', 'Other Person']
    })

    const aggregatedCustomersOfAcme4 = connection
      .subSelectUsing(tCompany)
      .from(tCustomer)
      .where(tCustomer.companyId.equals(tCompany.id))
      .select({
    ...
    const acmeCompanyWithCustomers4 = await connection
      .selectFrom(tCompany)
      .where(tCompany.id.equals(1))
      .select({
        id: tCompany.id,
    ...
    const aggregatedCustomersOfAcme5 = connection
      .subSelectUsing(tCompany)
      .from(tCustomer)
      .where(tCustomer.companyId.equals(tCompany.id))
      .select({
    ...
    const acmeCompanyWithCustomers5 = await connection
      .selectFrom(tCompany)
      .where(tCompany.id.equals(1))
      .select({
        id: tCompany.id,
    ...
    const aggregatedCustomersOfAcme6 = connection
      .subSelectUsing(tCompany)
      .from(tCustomer)
      .where(tCustomer.companyId.equals(tCompany.id))
    ...
    const acmeCompanyWithCustomers6 = await connection
      .selectFrom(tCompany)
      .where(tCompany.id.equals(1))
      .select({
        id: tCompany.id,
    ...
    const aggregatedCustomersOfAcme7 = connection
      .subSelectUsing(tCompany)
      .from(tCustomer)
      .where(tCustomer.companyId.equals(tCompany.id))
      .selectOneColumn(tCustomer.firstName.concat(' ').concat(tCustomer.lastName))
    ...
    const acmeCompanyWithCustomers7 = await connection
      .selectFrom(tCompany)
      .where(tCompany.id.equals(1))
      .select({
        id: tCompany.id,
    ...
    const aggregatedCustomersOfAcme8 = connection
      .subSelectUsing(tCompany)
      .from(tCustomer)
      .where(tCustomer.companyId.equals(tCompany.id))
      .select({
      ...
      .union(
        connection.subSelectUsing(tCompany).from(tCustomer).where(tCustomer.companyId.equals(tCompany.id)).select({
          id: tCustomer.id,
          firstName: tCustomer.firstName,
          lastName: tCustomer.lastName
        })
    ...
    const acmeCompanyWithCustomers8 = await connection
      .selectFrom(tCompany)
      .where(tCompany.id.equals(1))
      .select({
        id: tCompany.id,
    ...
    const aggregatedCustomersOfAcme9 = connection
      .subSelectUsing(tCompany)
      .from(tCustomer)
      .where(tCustomer.companyId.equals(tCompany.id))
      .select({
    ...
    const acmeCompanyWithCustomers9 = await connection
      .selectFrom(tCompany)
      .where(tCompany.id.equals(1))
      .select({
        id: tCompany.id,
    ...
    const aggregatedCustomersOfAcme10 = connection
      .subSelectUsing(tCompany)
      .from(tCustomer)
      .where(tCustomer.companyId.equals(tCompany.id))
      .selectOneColumn(tCustomer.firstName.concat(' ').concat(tCustomer.lastName))
    ...
    const acmeCompanyWithCustomers10 = await connection
      .selectFrom(tCompany)
      .where(tCompany.id.equals(1))
      .select({
        id: tCompany.id,
    ...
    const aggregatedCustomersOfAcme11 = connection
      .subSelectUsing(tCompany)
      .from(tCustomer)
      .where(tCustomer.companyId.equals(tCompany.id))
      .selectOneColumn(tCustomer.firstName.concat(' ').concat(tCustomer.lastName))
    ...
    const acmeCompanyWithCustomers11 = await connection
      .selectFrom(tCompany)
      .where(tCompany.id.equals(1))
      .select({
        id: tCompany.id,
    ...
    i = await connection.insertInto(tCompany).values({ name: 'Top Company' }).returningLastInsertedId().executeInsert()
    assertEquals(i, 8)
    i = await connection
      .insertInto(tCompany)
    ...
    const parentCompanies = connection
      .subSelectUsing(tCompany)
      .from(parentCompany)
      .select({
        id: parentCompany.id,
    ...
    const lowCompany = await connection
      .selectFrom(tCompany)
      .select({
        id: tCompany.id,
        name: tCompany.name,
    ...
    const parentCompanies2 = connection
      .selectFrom(parentCompany)
      .select({
        id: parentCompany.id,
        name: parentCompany.name,
        parentId: parentCompany.parentId
    ...
    const lowCompany2 = await connection
      .selectFrom(tCompany)
      .select({
        id: tCompany.id,
        name: tCompany.name,
    ...
    const lowCompany3 = await connection
      .selectFrom(tCompany)
      .select({
        id: tCompany.id,
        name: tCompany.name,
      ...
      .withMany((ids) => {
        return connection
          ...
          .recursiveUnionAll((child) => {
            return connection.selectFrom(parentCompany).join(child).on(child.parentId.equals(parentCompany.id)).select({
              id: parentCompany.id,
              name: parentCompany.name,
              parentId: parentCompany.parentId,
    ...
    const booleanSelect = await connection
      ...
      .and(
        tBoolean.customOptionalBooleanE.in(
          connection.selectFrom(booleanAlias).selectOneColumn(booleanAlias.optionalBoolB)
        )
      )
      .and(
        tBoolean.customOptionalBooleanF.in(
          connection.selectFrom(booleanAlias).selectOneColumn(booleanAlias.optionalBoolB)
        )
      )
      ...
      .and(
        tBoolean.customOptionalBooleanE.in(
          connection.selectFrom(booleanAlias).selectOneColumn(booleanAlias.customBooleanC)
        )
      )
      .and(
        tBoolean.customOptionalBooleanF.in(
      ...
      .and(
        tBoolean.customOptionalBooleanE.in(
          connection.selectFrom(booleanAlias).selectOneColumn(booleanAlias.customBooleanD)
        )
      )
      .and(
        tBoolean.customOptionalBooleanF.in(
      ...
      .and(
        tBoolean.optionalBoolB.in(
          connection.selectFrom(booleanAlias).selectOneColumn(booleanAlias.customOptionalBooleanE)
        )
      )
      .and(
        tBoolean.customBooleanC.in(
          connection.selectFrom(booleanAlias).selectOneColumn(booleanAlias.customOptionalBooleanE)
        )
      )
      .and(
        tBoolean.customBooleanD.in(
          connection.selectFrom(booleanAlias).selectOneColumn(booleanAlias.customOptionalBooleanE)
        )
      )
      .and(
      ...
      .and(
        tBoolean.optionalBoolB.in(
          connection.selectFrom(booleanAlias).selectOneColumn(booleanAlias.customOptionalBooleanF)
        )
      )
      .and(
        tBoolean.customBooleanC.in(
      ...
      .select({
        ...
        inlineOptionalBoolB: connection
          .selectFrom(booleanAlias)
          .selectOneColumn(booleanAlias.optionalBoolB)
          .forUseAsInlineQueryValue(),
        inlineCustomBooleanC: connection
          .selectFrom(booleanAlias)
          .selectOneColumn(booleanAlias.customBooleanC)
          .forUseAsInlineQueryValue(),
        inlineCustomBooleanD: connection
          .selectFrom(booleanAlias)
          .selectOneColumn(booleanAlias.customBooleanD)
          .forUseAsInlineQueryValue(),
        inlineCustomOptionalBooleanE: connection
          .selectFrom(booleanAlias)
          .selectOneColumn(booleanAlias.customOptionalBooleanE)
          .forUseAsInlineQueryValue(),
        inlineCustomOptionalBooleanF: connection
          .selectFrom(booleanAlias)
          .selectOneColumn(booleanAlias.customOptionalBooleanF)
          .forUseAsInlineQueryValue(),
        inlineAnds: connection
          .selectFrom(booleanAlias)
          .selectOneColumn(
            booleanAlias.boolA
    ...
    const booleanAggreagte = await connection
      ...
      .select({
        data: connection.aggregateAsArray({
          ...
          withAnds: booleanWith.ands,
          withOrs: booleanWith.ors,
          inlineBoolA: connection
            .selectFrom(booleanAlias)
            .selectOneColumn(booleanAlias.boolA)
            .forUseAsInlineQueryValue(),
          inlineOptionalBoolB: connection
            .selectFrom(booleanAlias)
            .selectOneColumn(booleanAlias.optionalBoolB)
    ...
    const aggreagateBooleanQueryResult = await connection
      .selectFromNoTable()
      .select({ data: aggreagateBooleanQuery })
      .executeSelectOne()

    assertEquals(aggreagateBooleanQueryResult, {
      data: [
        {
          boolA: true,
          optionalBoolB: true,
    ...
    assertEquals(booleanAggreagte2, {
      data: [
        {
          boolA: false,
          optionalBoolB: false,
    ...
    const aggreagateBooleanQueryResult2 = await connection
      .selectFromNoTable()
      .select({ data: aggreagateBooleanQuery })
      .executeSelectOne()

    assertEquals(aggreagateBooleanQueryResult2, {
      data: [
        {
          boolA: false,
          optionalBoolB: false,
    ...
    const booleanSelect3 = await connection
      ...
      .and(tBoolean.boolA.in(connection.selectFrom(booleanAlias).selectOneColumn(booleanAlias.boolA)))
      .and(
        tBoolean.optionalBoolB
          .valueWhenNull(true)
          .in(connection.selectFrom(booleanAlias).selectOneColumn(booleanAlias.boolA))
      )
      .and(tBoolean.customBooleanC.in(connection.selectFrom(booleanAlias).selectOneColumn(booleanAlias.boolA)))
      .and(tBoolean.customBooleanD.in(connection.selectFrom(booleanAlias).selectOneColumn(booleanAlias.boolA)))
      .and(
        tBoolean.customOptionalBooleanE
          .valueWhenNull(true)
          .in(connection.selectFrom(booleanAlias).selectOneColumn(booleanAlias.boolA))
      )
      .and(
        tBoolean.customOptionalBooleanF
          .valueWhenNull(true)
          .in(connection.selectFrom(booleanAlias).selectOneColumn(booleanAlias.boolA))
      )
      .and(
        tBoolean.boolA.in(
          connection.selectFrom(booleanAlias).selectOneColumn(booleanAlias.optionalBoolB.valueWhenNull(true))
        )
      )
      .and(
        tBoolean.optionalBoolB
          .valueWhenNull(false)
          .in(connection.selectFrom(booleanAlias).selectOneColumn(booleanAlias.optionalBoolB.valueWhenNull(false)))
      )
      .and(
        tBoolean.customBooleanC.in(
          connection.selectFrom(booleanAlias).selectOneColumn(booleanAlias.optionalBoolB.valueWhenNull(true))
      ...
      .and(
        tBoolean.optionalBoolB
          .valueWhenNull(true)
          .in(connection.selectFrom(booleanAlias).selectOneColumn(booleanAlias.customBooleanC))
      )
      .and(tBoolean.customBooleanC.in(connection.selectFrom(booleanAlias).selectOneColumn(booleanAlias.customBooleanC)))
      .and(tBoolean.customBooleanD.in(connection.selectFrom(booleanAlias).selectOneColumn(booleanAlias.customBooleanC)))
      .and(
      ...
      .and(
        tBoolean.optionalBoolB
          .valueWhenNull(true)
          .in(connection.selectFrom(booleanAlias).selectOneColumn(booleanAlias.customBooleanD))
      )
      .and(tBoolean.customBooleanC.in(connection.selectFrom(booleanAlias).selectOneColumn(booleanAlias.customBooleanD)))
      .and(tBoolean.customBooleanD.in(connection.selectFrom(booleanAlias).selectOneColumn(booleanAlias.customBooleanD)))
      .and(
      ...
      .and(
        tBoolean.boolA.in(
          connection.selectFrom(booleanAlias).selectOneColumn(booleanAlias.customOptionalBooleanE.valueWhenNull(true))
        )
      )
      .and(
        tBoolean.optionalBoolB
          ...
          .in(
            connection
              .selectFrom(booleanAlias)
              .selectOneColumn(booleanAlias.customOptionalBooleanE.valueWhenNull(false))
          )
      )
      .and(
        tBoolean.customBooleanC.in(
      ...
      .and(
        tBoolean.boolA.in(
          connection.selectFrom(booleanAlias).selectOneColumn(booleanAlias.customOptionalBooleanF.valueWhenNull(true))
        )
      )
      .and(
        tBoolean.optionalBoolB
          ...
          .in(
            connection
              .selectFrom(booleanAlias)
              .selectOneColumn(booleanAlias.customOptionalBooleanF.valueWhenNull(false))
          )
      )
      .and(
        tBoolean.customBooleanC.in(
    ...
    assertEquals(booleanAggreagte3, {
      data: [
        {
          boolA: true,
          // optionalBoolB: undefined,
    ...
    const aggreagateBooleanQueryResult3 = await connection
      .selectFromNoTable()
      .select({ data: aggreagateBooleanQuery })
      .executeSelectOne()

    assertEquals(aggreagateBooleanQueryResult3, {
      data: [
        {
          boolA: true,
          // optionalBoolB: undefined,
...
export async function run_ts_sql_query0() {
  main()
    .then(() => {
      console.log('All ok')
      process.exit(0)
