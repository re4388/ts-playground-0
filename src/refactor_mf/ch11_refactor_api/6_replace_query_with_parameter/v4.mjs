...
/**
 * As is often the case with this refactoring, the calling code looks more unwieldy than before.
 *
 * Moving a dependency out of a module pushes the responsibility of dealing with that dependency back to the caller. That’s the trade-off for the reduced coupling.
 *
 *
